		...
		function r(e){
			...
			x.autoplayTimeoutId=setTimeout(function(){
				x.params.loop?(
					x.fixLoop(),
					x._slideNext(),
					x.emit("onAutoplay",x)):x.isEnd?s.autoplayStopOnLast?x.stopAutoplay():(
						x._slideTo(0),
						x.emit("onAutoplay",x)):(
							x._slideNext(),
							x.emit("onAutoplay",x)
			...
			function o(e,a){
				...
				var t=window.MutationObserver||window.WebkitMutationObserver,
					...
					if(!x.params.allowSwipeToPrev&&(x.isHorizontal()&&37===a||!x.isHorizontal()&&38===a))
						return!1;
					if(!(
						e.shiftKey||e.altKey||e.ctrlKey||e.metaKey||document.activeElement&&document.activeElement.nodeName&&(
						...
						function d(e){
									...
									if(x.params.mousewheelInvert&&(a=-a),x.params.freeMode){
										...
										if(r>=x.minTranslate()&&(r=x.minTranslate()),
											...
											x.params.freeModeSticky?(
												...
												x.mousewheel.timeout=setTimeout(function(){x.slideReset()},300)):
										...
										if((new window.Date).getTime()-x.mousewheel.lastScrollTime>60)
											if(a<0)if(x.isEnd&&!x.params.loop||x.animating){
							...
							for(var v in s)
								...
								for(var w in c)
									...
									var x=this;
									if(x.params=s,x.originalParams=h,x.classNames=[],
										...
										}x.container[0].swiper=x,x.container.data("swiper",x),
										...
										["cube","coverflow","flip"].indexOf(x.params.effect)>=0&&(x.support.transforms3d?(
											x.params.watchSlidesProgress=!0,x.classNames.push(x.params.containerModifierClass+"3d")):
